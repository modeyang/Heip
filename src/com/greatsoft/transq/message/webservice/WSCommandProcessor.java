 ...
 * Dispatcher模块的命令监视器
 * */
public class WSCommandProcessor implements Runnable {
	private Logger log = Logger.getLogger(WSCommandProcessor.class);
	...
	public WSCommandProcessor(int port) {
		this.port = port;
