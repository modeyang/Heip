 ...
 * Dispatcher模块的命令监视器
 * */
public class RouterCommandProcessor implements Runnable {
	private static Logger log = Logger.getLogger(RouterCommandProcessor.class);
	...
	public RouterCommandProcessor(int port, HiepController controller) {
		this.port = port;
